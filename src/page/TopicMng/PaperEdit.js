...
class PaperEdit extends Component {
    ...
    componentDidMount(){
        ...
        const ctype = this.props.match.params.ctype
        ...
        if(ctype=='27'){
            ...
            this.cate_ctype = 25 //题目分类
            this.topic_ctype = 25 //习题分类
            this.paper_ctype = 26
            this.setState({
                ctype:26
            })
                            ...
                            <Col xs="12">
                                <Card title="" style={{minHeight:'400px'}}>
                                    ...
                                    <div className="flex f_row j_center">
                                        ...
                                        &nbsp;
                                        {view_mode?null:
                                            <Button onClick={this._onPublish} type="primary" loading={importLoading||loading}>{importLoading?'正在上传':'提交'}</Button>
                                        }
                                    </div>
                                </Card>
                            </Col>
...
const LayoutComponent =PaperEdit;
