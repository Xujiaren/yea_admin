...
class LuckyList extends Component {
    ...
    componentDidMount(){
        ...
        actions.getActiveReward({activity_id:1})
    }
            ...
            <Row>
                    ...
                    <Card bodyStyle={{padding:0}}>
                        <CardHeader className="flex j_space_between align_items">
                            ...
                            <div>
                                <Button onClick={this.showRandom}>批量生成获奖信息</Button>&nbsp;
                                    ...
                                    <tr key={ele.rewardId+'reward'}> 
                                        ...
                                        <td style={{width:'200px' }}>
                                            ...
                                            {ele.ctype == 2&&!ele.isAdmin?
                                                <Button onClick={this.showPost.bind(this,index)} size={'small'}>邮寄</Button>
                                            :null}
                                        </td>
                                    </tr>
                                )}
...
const LayoutComponent = LuckyList;
