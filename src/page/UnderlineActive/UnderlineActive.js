                    ...
                    <Table responsive size="sm">
                        ...
                        {this.squad_list.map((ele,index)=>(
                            <tr key={ele.squadId}>
                                ...
                                <td>
                                    <div>
                                        <Button value='underActive/status' type={ele.status==1?"primary":''} className='m_2' size={'small'} onClick={this._onUpdate.bind(this,ele.squadId,'status')}>{ele.status==1?'下架':'上架'}</Button>
                                        {/* <Button value='underActive/in' className='m_2' size={'small'} onClick={this.showImportPannel.bind(this,ele.squadId)}>导入</Button> */}
...
const LayoutComponent = UnderlineActive;
