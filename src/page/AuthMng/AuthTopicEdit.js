...
class AuthTopicEdit extends Component {
    state = {
        fileList:[],
        media_value:[],
    ...
    render(){
        ...
        return(
            <div className="animated fadeIn">
                                    ...
                                    <Form {...formItemLayout}>
                                        ...
                                        <Form.Item label="题目形式">
                                            ...
                                            >
                                                ...
                                                <Select.Option value={2}>视频题目</Select.Option>
                                                <Select.Option value={3}>音频题目</Select.Option>
                                            </Select>
                                        </Form.Item>
                                        ...
                                        <Form.Item label={media_label}>
                                            <AntdOssUpload actions={this.props.actions} accept={mtype==1?"image/*":mtype==2?"video/mp4":mtype==3?"audio/*":""} value={this.state.media_value} ref={ref=>this.uploadMedia = ref}/>
                                        </Form.Item>
                                        :null}
                ...
                <Modal zIndex={10} visible={this.state.previewVisible} maskClosable={true} footer={null} onCancel={()=>{ this.setState({previewVisible:false}) }}>
...
const LayoutComponent =AuthTopicEdit;
