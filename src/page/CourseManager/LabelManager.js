                    ...
                    <Col xs="12">
                        <Card title="标签列表" style={{minHeight:'400px'}}>
                            <div className="flex f_row j_space_between align_items mb_10">
                                ...
                                <div>
                                    <Button value='label/add' onClick={this.showModal.bind(this,"添加标签",'add')}>添加标签</Button>
                                </div>
                            </div>
                                ...
                                {this.tag_list.map((ele,index)=>(
                                    <tr key={index+'tag'}>
                                        ...
                                        <td style={{width:'320px'}}>
                                            <div>
                                                <Button  value='label/all' onClick={()=>{
                                                    this.props.history.push('/course-manager/label-detail/'+ele.tagId)
                                                }} type="primary" size={'small'}>所有课程</Button>
                                                &nbsp;
                                                <Button value='label/view' type="primary" size={'small'} onClick={this.showModal.bind(this,"查看",index)}>查看</Button>&nbsp;
                                                <Button value='label/edit' type="primary" size={'small'} onClick={this.showModal.bind(this,"修改",index)}>修改</Button>&nbsp;
                                                <Button  value='label/edit' onClick={this._onUpdate.bind(this,ele.tagId)} type={ele.status == 0?"primary":'danger'} ghost size={'small'}>{ele.status == 1?'禁用':'启用'}</Button>&nbsp;
                                                <Popconfirm 
                                                    value='label/del'
                                                    okText="确定"
                                                    cancelText='取消'
...
const LayoutComponent =LabelManager;
