...
import { convertHTMLToRaw, convertRawToEditorState, convertHTMLToEditorState, convertEditorStateToRaw, convertEditorStateToHTML } from '../braft-convert'
...
BraftEditor.createEditorState = EditorState.createFrom = (content, options = {}) => {
  ...
  console.log(convertHTMLToRaw(content))
